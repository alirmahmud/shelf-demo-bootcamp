...
(A 1×3 grid gives a narrower red region but relies on a detection sitting
exactly on the 0.15 confidence cutoff — it flips between environments, so
the deployed defaults use the wider-margin 1×2/0.20 calibration.)
